...
public:
    ...
    std::vector<float> euler(float t, float h, const std::vector<float>& y0, glm::vec3 addVel,glm::vec3 earthPos,bool m,bool energy);
    ...
    void advanceState(float t, float h,glm::vec3 addVel,glm::vec3 earthPos,bool m,bool energy);
